    ...
    <div className={`absolute inset-0 bg-cover bg-center ${styles.backgroundImage} `}>
      <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
        <div className="w-[400px] h-[270px] p-6 bg-gray-300 rounded-tl-[20px] rounded-br-[20px] shadow-md relative">
          ...
          <p className="font-montserrat text-2xl text-center">Login to continue</p>
          <div className="flex items-center justify-center">
            {/* Link the button to the login page */}
            <Link to="/login" className="p-3 w-[50%] h-12 bg-blue-500 text-white mt-[8%] rounded-md">
              Login
            </Link>
          </div>
        </div>

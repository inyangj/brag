...
const Business = () => {
  ...
  return (
    <BusinessNameProvider initialBusinessName={businessName}>
      <div>
        <div className="background grid justify-center items-center mt-12 text-white">
          <h2 className="text-3xl md:text-6xl font-bold mt-10 md:text-white">
            Business Content
          </h2>
        </div>
        ...
        <div className="px-6  py-6 lg:px-12 lg:py-[1.88rem] ">
          ...
          <section className="md:flex items-center gap-8 md:gap-14">
            ...
            <div className="w-full pt-5 grid gap-5 md:gap-10">
              <TextRender title={`Business name`} content={`${businessName}`} />
              <TextRender
          ...
          <section className="grid gap-5 w-full ">
            ...
            <div className=" ">
              ...
              <div
                className="flex items-center gap-2 w-[200px] sm:w-full
            "
              >

    ...
    <div >
      ...
      <section className="md:flex items-center gap-8 md:gap-14">
        ...
        <div className="w-full pt-5 grid gap-5 md:gap-10">
          <TextRender title={`Business name`} content={`ShoeCorner Nigeria`} />
      ...
      <section className="grid gap-5 md:gap-10">
        ...
        <Services styleName={`grid gap-5 md:gap-10`} className={`border-[#A9A9A9] text-2xl rounded-[10px] py-4 pl-8 `}/>
        <div className=" ">
          ...
          <div className="flex items-center gap-2 ">
            ...
            <CopyToClipboard text={`http://localhost:5173/business/${id}`} onCopy={handleCopy}>
      ...
      <section>
        <h2 className="text-xl rounded-[10px] text-[#095EDC] font-medium mx-auto border w-fit shadow-sm mb-7 p-3 md:p-5">Reivews</h2>
        <Services styleName={`flex justify-center items-center flex-wrap gap-5 md:gap-[53px]`} className={` py-4 px-3 rounded-[10px] text-[#095EDC] border-[#095EDC] `}/>
      </section>
              </div>
    </div>
  );
